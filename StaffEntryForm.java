...
public class StaffEntryForm {
	...
	public void displayStudent(String staff_id) throws Exception {
		DisplayStudentcmd = "select st.stu_id as ID,st.stu_name as NAME,sub.subject_name as SUBJECT,m.mark1,m.mark2,m.mark3,m.mark4,m.mark5,m.mark6 from cms.mark m join cms.student st on m.stu_id = st.stu_id join cms.subject sub on m.subject_id = sub.subject_id where sub.staff_id = "
